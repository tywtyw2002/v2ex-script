...
(t=>{const e=document.createElement("style");e.dataset.source="vite-plugin-monkey",e.textContent=t,document.head.append(e)})(' .v-enter-active,.v-leave-active{transition:opacity .3s ease}.v-enter-from,.v-leave-to{opacity:0}.username{font-weight:700;font-size:1.4rem;margin-right:1rem}.op{display:inline-block;background-color:transparent;color:#1484cd;border-radius:.3rem;padding:0 .3rem;cursor:default;border:2px solid #1484cd;font-size:1.2rem;font-weight:700;margin-right:1rem;transform:scale(.8)}.mod{display:inline-block;background-color:transparent;color:#1484cd;border-radius:.3rem;padding:0 .3rem;cursor:default;border:2px solid #1484cd;font-size:1.2rem;font-weight:700;transform:scale(.8);background:#1484cd;color:#fff;margin-right:1rem}.my-tag{font-size:1.4rem;color:red;margin-left:1rem}.my-tag:hover .remove{display:inline}.my-tag .remove{cursor:pointer;margin-left:.5rem;display:none}.add-tag{font-size:2.4rem;transform:translateY(.1rem);line-height:1rem;display:inline-block;margin-left:1rem;cursor:pointer;position:absolute;display:none}.floor{margin-left:1rem;font-size:1.2rem;line-height:1rem;border-radius:1rem;display:inline-block;background-color:#f0f0f0;color:#bdbdbd;padding:4px 12px;cursor:default}html,body{font-size:62.5%}.flex{display:flex;align-items:center;justify-content:space-between}.flex-end{justify-content:flex-end}.flex-center{justify-content:center}.p1{padding:1rem}.p0{padding:0!important}.post-author{display:flex;align-items:center;position:relative;color:#ccc!important}.post-author>.username{font-size:1.2rem}.sticky{position:sticky;bottom:0}.sticky[stuck]{box-shadow:0 2px 20px #00000059}a{color:#778087;text-decoration:none;cursor:pointer}a:hover{text-decoration:underline}.base-loading{border:2px solid;border-color:#000 #00000033 #00000033 #00000033;border-radius:100%;animation:circle infinite 1s linear}.loading-c{border:2px solid;border-color:#000 #00000033 #00000033 #00000033;border-radius:100%;animation:circle infinite 1s linear;width:3rem;height:3rem}.loading-b{border:2px solid;border-color:#000 #00000033 #00000033 #00000033;border-radius:100%;animation:circle infinite 1s linear;border-color:#ffffff rgba(178,177,177,.2) rgba(178,177,177,.2) rgba(178,177,177,.2);width:3rem;height:3rem}@keyframes circle{0%{transform:rotate(0)}to{transform:rotate(360deg)}}.button{cursor:pointer;padding:.4rem 2.4rem;border-radius:5px;display:inline-flex;justify-content:center;align-items:center;font-weight:700;font-size:1.2rem;color:#fff;background:#40a9ff;border:1px solid #40a9ff;user-select:none}.button:hover{opacity:.9}.button.info{color:#000;border:1px solid #40a9ff;background:white}.button.gray{color:#f5f5f5;border:1px solid #b6b6b6;background:#b6b6b6}.button.light{color:gray;border:1px solid #e2e2e2;background:#e2e2e2}.button:before{content:" ";border:2px solid;border-color:#000 #00000033 #00000033 #00000033;border-radius:100%;animation:circle infinite 1s linear;border-color:#fff transparent transparent transparent;width:1rem;height:1rem;margin-right:1rem;display:none}.button.loading{cursor:not-allowed;opacity:.5}.button.loading:before{display:block}.button.disabled{cursor:not-allowed;color:#c6c6c6;background:#8d8d8d;border:1px solid transparent}.button.isNight{color:#c6c6c6;background:#2b4054;border:1px solid transparent}.tool{position:relative;margin-left:1rem;display:flex;align-items:center;font-size:1.2rem;font-weight:700;border-radius:.3rem;cursor:pointer;height:2.4rem;padding:0 .5rem}.tool:before{content:" ";border:2px solid;border-color:#000 #00000033 #00000033 #00000033;border-radius:100%;animation:circle infinite 1s linear;border-color:transparent #929596 #929596 #929596;width:1rem;height:1rem;margin-left:1rem;display:none}.tool.loading{cursor:not-allowed;opacity:.5}.tool.loading:before{display:block}.tool.loading:hover{background:unset}.tool>svg{width:1.6rem!important;height:1.6rem!important;margin-right:.4rem;box-sizing:border-box;border-radius:.2rem}.tool:hover{background:#e8e8e8}.tool.no-hover{cursor:default}.tool.no-hover:hover{background:unset}.my-node{border-radius:.2rem;padding:.4rem;font-size:1rem;color:#999;background:#f5f5f5;cursor:pointer}.my-node:hover{text-decoration:none;background:#e2e2e2}.msgs{position:fixed;margin-left:calc(50% - 25rem);width:50rem;z-index:9999;bottom:0;left:0;right:0}.msg{cursor:default;margin-bottom:2rem;background:white;display:flex;color:#000;font-size:1.4rem;box-sizing:border-box;border-radius:8px;box-shadow:0 0 1rem 1px silver}.msg.success .left{background:#40a9ff}.msg.warning .left{background:#c8c002}.msg.error .left{background:red}.msg .left{border-radius:8px 0 0 8px;display:flex;align-items:center;background:#40a9ff}.msg .left svg{margin:0 .3rem;cursor:pointer}.msg .right{flex:1;padding:1rem 2rem;display:flex;justify-content:space-between;align-items:center}.line{border-bottom:1px solid #e2e2e2}.my-box{box-shadow:0 2px 3px #0000001a;box-shadow:#00000014 0 4px 12px;border-radius:var(--box-border-radius);background:white;margin-bottom:2rem;width:100%;overflow:hidden;box-sizing:border-box}.my-cell{padding:.6rem 1rem;font-size:1.4rem;line-height:150%;text-align:left;border-bottom:1px solid #e2e2e2}.f14{font-size:1.4rem}.switch{width:4.5rem;height:2rem;border-radius:2rem;position:relative;display:flex;align-items:center;transition:all .3s}.switch.light{border:1px solid #e2e2e2}.switch.light.active{background:#e2e2e2}.switch.light.active:before{right:.2rem;background:white}.switch.light:before{background:#e2e2e2}.switch.gray{border:1px solid #ccc}.switch.gray.active{background:#ccc}.switch.gray.active:before{right:.2rem;background:white}.switch.gray:before{background:#ccc}.switch.isNight{border:1px solid #31475e}.switch.isNight.active{background:#31475e}.switch.isNight.active:before{right:.2rem;background:gray}.switch.isNight:before{background:#31475e}.switch:before{position:absolute;content:" ";transition:all .3s;right:calc(100% - 2rem);width:1.8rem;height:1.8rem;border-radius:50%}.modal{position:fixed;z-index:100;width:100vw;height:100vh;left:0;top:0;display:flex;justify-content:center;align-items:center}.modal .title{font-size:2.4rem;margin-bottom:1rem;text-align:center}.modal .option{display:flex;justify-content:space-between;align-items:center;padding:.6rem 0}.modal .option>span{position:relative}.modal .mask{position:fixed;width:100vw;height:100vh;left:0;top:0;background:rgba(0,0,0,.3)}.radio-group2{display:inline-flex;border-radius:.5rem;overflow:hidden;border:1px solid #e2e2e2}.radio-group2 .radio{cursor:pointer;background:transparent;padding:.3rem 1rem;border-left:1px solid #e2e2e2;color:#9ca1a4;font-size:1.2rem}.radio-group2 .radio:first-child{border-left:none}.radio-group2 .active{background:#e2e2e2;color:gray}.radio-group2.isNight{border:1px solid #454847}.radio-group2.isNight .radio{border-left:1px solid #454847;color:#fff}.radio-group2.isNight .active{background:#31475e}.pop-confirm{position:relative;display:inline-flex;justify-content:center}.tip{position:fixed;background:black;color:#fff;max-width:10rem;font-size:1.4rem;padding:.7rem 1rem;border-radius:.5rem;transform:translate(-50%);z-index:999}input{height:3rem;outline:unset;border:1px solid #e1e1e1;padding:0 .5rem;border-radius:5px;box-sizing:border-box}.isNight .wrapper[data-v-afbd285a]{background:#22303f!important}.isNight .wrapper .title[data-v-afbd285a],.isNight .wrapper .option-title[data-v-afbd285a],.isNight .wrapper .option>span[data-v-afbd285a]{color:#a9a9a9}.isNight .wrapper .notice[data-v-afbd285a]{color:gray!important}.setting-modal .wrapper[data-v-afbd285a]{z-index:9;background:#f1f1f1;border-radius:.8rem;font-size:1.4rem;padding:2rem;max-height:80vh;max-width:83vw;overflow:auto}.setting-modal .wrapper .sub-title[data-v-afbd285a]{color:gray;font-size:1.4rem}.setting-modal .wrapper .option-title[data-v-afbd285a]{text-align:start;font-size:1.6rem;font-weight:700;margin-top:1.5rem}.setting-modal .wrapper .body[data-v-afbd285a]{display:flex;gap:3rem}.setting-modal .wrapper .body .option-list[data-v-afbd285a]{width:50rem}.setting-modal .wrapper .notice[data-v-afbd285a]{font-size:12px;padding-left:3rem;text-align:left}.setting-modal .wrapper .notice a[data-v-afbd285a]{color:#00f}.pop-confirm-content[data-v-46b6bc70]{position:fixed;background:white;padding:1.5rem;box-shadow:0 0 12px #0003;border-radius:.4rem;transform:translate(-50%,calc(-100% - 1rem));z-index:999}.pop-confirm-content .text[data-v-46b6bc70]{color:#000;text-align:start;font-size:1.4rem;width:15rem;min-width:15rem}.pop-confirm-content .options[data-v-46b6bc70]{margin-top:1.5rem;display:flex;justify-content:flex-end;align-items:center;gap:1rem;font-size:1rem}.pop-confirm-content .options div[data-v-46b6bc70]{cursor:pointer}.pop-confirm-content .options .main[data-v-46b6bc70]{color:gray;background:#e2e2e2;padding:.3rem .8rem;border-radius:.2rem}.point[data-v-97e3a46a]{margin-left:1rem;font-size:1.2rem;min-width:4rem;border-radius:8px 0 0 8px;display:flex;align-items:center;flex-direction:row!important;padding:0!important}.point .up[data-v-97e3a46a]{display:flex;flex-direction:column;align-items:center;justify-content:center}.point .num[data-v-97e3a46a]{margin-left:.2rem;font-weight:700;color:#000;user-select:none}.point svg[data-v-97e3a46a]{width:2rem;padding:.4rem;border-radius:.2rem}.point svg[data-v-97e3a46a]:hover{background:#e5e5e5}.point svg.disabled[data-v-97e3a46a]{cursor:not-allowed}.point svg.disabled[data-v-97e3a46a]:hover{background:unset!important}.Author[data-v-2730d0b7]{display:flex;align-items:center;justify-content:space-between;font-size:1.2rem;position:relative}.Author.expand[data-v-2730d0b7]{margin-bottom:0}.Author .Author-left[data-v-2730d0b7]{display:flex;align-items:center;max-width:65%;word-break:break-all}.Author .Author-left .username[data-v-2730d0b7]{font-size:1.4rem;margin-right:1rem}.Author .Author-left .expand-icon[data-v-2730d0b7]{cursor:pointer;margin-right:.8rem;width:2rem;height:2rem;transform:rotate(90deg)}.Author .Author-left .avatar[data-v-2730d0b7]{margin-right:1rem;display:flex}.Author .Author-left .avatar img[data-v-2730d0b7]{width:2.8rem;height:2.8rem;border-radius:.4rem}.Author .Author-left .texts[data-v-2730d0b7]{flex:1}.Author .Author-left .op[data-v-2730d0b7]{display:inline-block;background-color:transparent;color:#1484cd;border-radius:.3rem;padding:0 .3rem;cursor:default;border:2px solid #1484cd;font-size:1.2rem;font-weight:700;margin-right:1rem;transform:scale(.8)}.Author .Author-left .dup[data-v-2730d0b7]{display:inline-block;background-color:transparent;color:red;border-radius:.3rem;padding:0 .3rem;cursor:default;border:2px solid red;font-size:1.2rem;font-weight:700;margin-right:1rem;transform:scale(.8)}.Author .Author-left .mod[data-v-2730d0b7]{display:inline-block;background-color:transparent;color:#1484cd;border-radius:.3rem;padding:0 .3rem;cursor:default;border:2px solid #1484cd;font-size:1.2rem;font-weight:700;transform:scale(.8);background:#1484cd;color:#fff;margin-right:1rem}.Author:hover .add-tag[data-v-2730d0b7]{display:inline-block}.Author .Author-right[data-v-2730d0b7]{position:absolute;right:0;display:flex;align-items:center}.Author .Author-right .toolbar[data-v-2730d0b7]{display:flex;align-items:center;color:#929596;opacity:0}.Author .Author-right .toolbar[data-v-2730d0b7]:hover{background:white;opacity:1}.Author .Author-right .isDev[data-v-2730d0b7]{color:#000!important}.post-editor-wrapper[data-v-7ff2843d]{width:100%;box-sizing:border-box;position:relative;overflow:hidden;transition:all .3s}.post-editor-wrapper.reply-post .post-editor[data-v-7ff2843d]{border:1px solid #e2e2e2;border-radius:.4rem}.post-editor-wrapper.reply-post.isFocus .post-editor[data-v-7ff2843d]{border:1px solid #968b8b}.post-editor-wrapper.reply-comment[data-v-7ff2843d]{border:1px solid #e2e2e2;border-radius:.4rem;overflow:hidden}.post-editor-wrapper.reply-comment.isFocus[data-v-7ff2843d]{border:1px solid #968b8b}.post-editor-wrapper.reply-comment .toolbar[data-v-7ff2843d]{background:#f6f7f8}.post-editor-wrapper .post-editor[data-v-7ff2843d]{transition:border .3s;width:100%;max-width:100%;padding:.6rem 1.4rem;box-sizing:border-box;border:none;outline:none;font-family:Avenir,Helvetica,Arial,sans-serif;font-size:1.4rem;min-height:13rem;resize:none}.post-editor-wrapper .toolbar[data-v-7ff2843d]{box-sizing:border-box;padding:.5rem 1rem;width:100%;position:relative;display:flex;justify-content:space-between;align-items:center}.post-editor-wrapper .toolbar .left[data-v-7ff2843d]{display:flex;gap:1rem}.post-editor-wrapper .toolbar .left svg[data-v-7ff2843d]{cursor:pointer}.post-editor-wrapper .toolbar .left .upload input[data-v-7ff2843d]{cursor:pointer;position:absolute;width:20px;height:20px;opacity:0}.post-editor-wrapper .toolbar span[data-v-7ff2843d]{color:gray;font-size:1.3rem}.post-editor-wrapper .get-cursor[data-v-7ff2843d]{transition:border .3s;width:100%;max-width:100%;padding:.6rem 1.4rem;box-sizing:border-box;border:none;outline:none;font-family:Avenir,Helvetica,Arial,sans-serif;font-size:1.4rem;min-height:13rem;resize:none;position:absolute;top:0;z-index:-100}.post-editor-wrapper .emoticon-pack[data-v-7ff2843d]{z-index:999999999;border-radius:1rem;padding:1rem;width:31rem;max-width:31rem;height:30rem;max-height:30rem;overflow:auto;background:white;border:1px solid #e2e8f0;box-shadow:0 9px 24px -3px #0000000f,0 4px 8px -1px #0000001f;position:fixed;bottom:11rem;left:14rem}.post-editor-wrapper .emoticon-pack i[data-v-7ff2843d]{cursor:pointer;position:absolute;right:2rem;font-size:2rem;color:#e2e2e2}.post-editor-wrapper .emoticon-pack .list[data-v-7ff2843d]{margin:1rem 0}.post-editor-wrapper .emoticon-pack img[data-v-7ff2843d]{cursor:pointer;width:3rem;height:3rem;padding:.5rem}.post-editor-wrapper .emoticon-pack span[data-v-7ff2843d]{display:inline-block;cursor:pointer;font-size:2.3rem;padding:.5rem}.isNight .emoticon-pack[data-v-7ff2843d]{background:#18222d;border:1px solid #737373}.v-enter-active[data-v-e5a113c8],.v-leave-active[data-v-e5a113c8]{transition:opacity .3s ease}.v-enter-from[data-v-e5a113c8],.v-leave-to[data-v-e5a113c8]{opacity:0}.username[data-v-e5a113c8]{font-weight:700;font-size:1.4rem;margin-right:1rem}.op[data-v-e5a113c8]{display:inline-block;background-color:transparent;color:#1484cd;border-radius:.3rem;padding:0 .3rem;cursor:default;border:2px solid #1484cd;font-size:1.2rem;font-weight:700;margin-right:1rem;transform:scale(.8)}.mod[data-v-e5a113c8]{display:inline-block;background-color:transparent;color:#1484cd;border-radius:.3rem;padding:0 .3rem;cursor:default;border:2px solid #1484cd;font-size:1.2rem;font-weight:700;transform:scale(.8);background:#1484cd;color:#fff;margin-right:1rem}.my-tag[data-v-e5a113c8]{font-size:1.4rem;color:red;margin-left:1rem}.my-tag:hover .remove[data-v-e5a113c8]{display:inline}.my-tag .remove[data-v-e5a113c8]{cursor:pointer;margin-left:.5rem;display:none}.add-tag[data-v-e5a113c8]{font-size:2.4rem;transform:translateY(.1rem);line-height:1rem;display:inline-block;margin-left:1rem;cursor:pointer;position:absolute;display:none}.floor[data-v-e5a113c8]{margin-left:1rem;font-size:1.2rem;line-height:1rem;border-radius:1rem;display:inline-block;background-color:#f0f0f0;color:#bdbdbd;padding:4px 12px;cursor:default}html[data-v-e5a113c8],body[data-v-e5a113c8]{font-size:62.5%}.flex[data-v-e5a113c8]{display:flex;align-items:center;justify-content:space-between}.flex-end[data-v-e5a113c8]{justify-content:flex-end}.flex-center[data-v-e5a113c8]{justify-content:center}.p1[data-v-e5a113c8]{padding:1rem}.p0[data-v-e5a113c8]{padding:0!important}.post-author[data-v-e5a113c8]{display:flex;align-items:center;position:relative;color:#ccc!important}.post-author>.username[data-v-e5a113c8]{font-size:1.2rem}.sticky[data-v-e5a113c8]{position:sticky;bottom:0}.sticky[stuck][data-v-e5a113c8]{box-shadow:0 2px 20px #00000059}a[data-v-e5a113c8]{color:#778087;text-decoration:none;cursor:pointer}a[data-v-e5a113c8]:hover{text-decoration:underline}.base-loading[data-v-e5a113c8]{border:2px solid;border-color:#000 #00000033 #00000033 #00000033;border-radius:100%;animation:circle-e5a113c8 infinite 1s linear}.loading-c[data-v-e5a113c8]{border:2px solid;border-color:#000 #00000033 #00000033 #00000033;border-radius:100%;animation:circle-e5a113c8 infinite 1s linear;width:3rem;height:3rem}.loading-b[data-v-e5a113c8]{border:2px solid;border-color:#000 #00000033 #00000033 #00000033;border-radius:100%;animation:circle-e5a113c8 infinite 1s linear;border-color:#ffffff rgba(178,177,177,.2) rgba(178,177,177,.2) rgba(178,177,177,.2);width:3rem;height:3rem}@keyframes circle-e5a113c8{0%{transform:rotate(0)}to{transform:rotate(360deg)}}.button[data-v-e5a113c8]{cursor:pointer;padding:.4rem 2.4rem;border-radius:5px;display:inline-flex;justify-content:center;align-items:center;font-weight:700;font-size:1.2rem;color:#fff;background:#40a9ff;border:1px solid #40a9ff;user-select:none}.button[data-v-e5a113c8]:hover{opacity:.9}.button.info[data-v-e5a113c8]{color:#000;border:1px solid #40a9ff;background:white}.button.gray[data-v-e5a113c8]{color:#f5f5f5;border:1px solid #b6b6b6;background:#b6b6b6}.button.light[data-v-e5a113c8]{color:gray;border:1px solid #e2e2e2;background:#e2e2e2}.button[data-v-e5a113c8]:before{content:" ";border:2px solid;border-color:#000 #00000033 #00000033 #00000033;border-radius:100%;animation:circle-e5a113c8 infinite 1s linear;border-color:#fff transparent transparent transparent;width:1rem;height:1rem;margin-right:1rem;display:none}.button.loading[data-v-e5a113c8]{cursor:not-allowed;opacity:.5}.button.loading[data-v-e5a113c8]:before{display:block}.button.disabled[data-v-e5a113c8]{cursor:not-allowed;color:#c6c6c6;background:#8d8d8d;border:1px solid transparent}.button.isNight[data-v-e5a113c8]{color:#c6c6c6;background:#2b4054;border:1px solid transparent}.tool[data-v-e5a113c8]{position:relative;margin-left:1rem;display:flex;align-items:center;font-size:1.2rem;font-weight:700;border-radius:.3rem;cursor:pointer;height:2.4rem;padding:0 .5rem}.tool[data-v-e5a113c8]:before{content:" ";border:2px solid;border-color:#000 #00000033 #00000033 #00000033;border-radius:100%;animation:circle-e5a113c8 infinite 1s linear;border-color:transparent #929596 #929596 #929596;width:1rem;height:1rem;margin-left:1rem;display:none}.tool.loading[data-v-e5a113c8]{cursor:not-allowed;opacity:.5}.tool.loading[data-v-e5a113c8]:before{display:block}.tool.loading[data-v-e5a113c8]:hover{background:unset}.tool>svg[data-v-e5a113c8]{width:1.6rem!important;height:1.6rem!important;margin-right:.4rem;box-sizing:border-box;border-radius:.2rem}.tool[data-v-e5a113c8]:hover{background:#e8e8e8}.tool.no-hover[data-v-e5a113c8]{cursor:default}.tool.no-hover[data-v-e5a113c8]:hover{background:unset}.my-node[data-v-e5a113c8]{border-radius:.2rem;padding:.4rem;font-size:1rem;color:#999;background:#f5f5f5;cursor:pointer}.my-node[data-v-e5a113c8]:hover{text-decoration:none;background:#e2e2e2}.msgs[data-v-e5a113c8]{position:fixed;margin-left:calc(50% - 25rem);width:50rem;z-index:9999;bottom:0;left:0;right:0}.msg[data-v-e5a113c8]{cursor:default;margin-bottom:2rem;background:white;display:flex;color:#000;font-size:1.4rem;box-sizing:border-box;border-radius:8px;box-shadow:0 0 1rem 1px silver}.msg.success .left[data-v-e5a113c8]{background:#40a9ff}.msg.warning .left[data-v-e5a113c8]{background:#c8c002}.msg.error .left[data-v-e5a113c8]{background:red}.msg .left[data-v-e5a113c8]{border-radius:8px 0 0 8px;display:flex;align-items:center;background:#40a9ff}.msg .left svg[data-v-e5a113c8]{margin:0 .3rem;cursor:pointer}.msg .right[data-v-e5a113c8]{flex:1;padding:1rem 2rem;display:flex;justify-content:space-between;align-items:center}.line[data-v-e5a113c8]{border-bottom:1px solid #e2e2e2}.my-box[data-v-e5a113c8]{box-shadow:0 2px 3px #0000001a;box-shadow:#00000014 0 4px 12px;border-radius:var(--box-border-radius);background:white;margin-bottom:2rem;width:100%;overflow:hidden;box-sizing:border-box}.my-cell[data-v-e5a113c8]{padding:.6rem 1rem;font-size:1.4rem;line-height:150%;text-align:left;border-bottom:1px solid #e2e2e2}.f14[data-v-e5a113c8]{font-size:1.4rem}.switch[data-v-e5a113c8]{width:4.5rem;height:2rem;border-radius:2rem;position:relative;display:flex;align-items:center;transition:all .3s}.switch.light[data-v-e5a113c8]{border:1px solid #e2e2e2}.switch.light.active[data-v-e5a113c8]{background:#e2e2e2}.switch.light.active[data-v-e5a113c8]:before{right:.2rem;background:white}.switch.light[data-v-e5a113c8]:before{background:#e2e2e2}.switch.gray[data-v-e5a113c8]{border:1px solid #ccc}.switch.gray.active[data-v-e5a113c8]{background:#ccc}.switch.gray.active[data-v-e5a113c8]:before{right:.2rem;background:white}.switch.gray[data-v-e5a113c8]:before{background:#ccc}.switch.isNight[data-v-e5a113c8]{border:1px solid #31475e}.switch.isNight.active[data-v-e5a113c8]{background:#31475e}.switch.isNight.active[data-v-e5a113c8]:before{right:.2rem;background:gray}.switch.isNight[data-v-e5a113c8]:before{background:#31475e}.switch[data-v-e5a113c8]:before{position:absolute;content:" ";transition:all .3s;right:calc(100% - 2rem);width:1.8rem;height:1.8rem;border-radius:50%}.modal[data-v-e5a113c8]{position:fixed;z-index:100;width:100vw;height:100vh;left:0;top:0;display:flex;justify-content:center;align-items:center}.modal .title[data-v-e5a113c8]{font-size:2.4rem;margin-bottom:1rem;text-align:center}.modal .option[data-v-e5a113c8]{display:flex;justify-content:space-between;align-items:center;padding:.6rem 0}.modal .option>span[data-v-e5a113c8]{position:relative}.modal .mask[data-v-e5a113c8]{position:fixed;width:100vw;height:100vh;left:0;top:0;background:rgba(0,0,0,.3)}.radio-group2[data-v-e5a113c8]{display:inline-flex;border-radius:.5rem;overflow:hidden;border:1px solid #e2e2e2}.radio-group2 .radio[data-v-e5a113c8]{cursor:pointer;background:transparent;padding:.3rem 1rem;border-left:1px solid #e2e2e2;color:#9ca1a4;font-size:1.2rem}.radio-group2 .radio[data-v-e5a113c8]:first-child{border-left:none}.radio-group2 .active[data-v-e5a113c8]{background:#e2e2e2;color:gray}.radio-group2.isNight[data-v-e5a113c8]{border:1px solid #454847}.radio-group2.isNight .radio[data-v-e5a113c8]{border-left:1px solid #454847;color:#fff}.radio-group2.isNight .active[data-v-e5a113c8]{background:#31475e}.pop-confirm[data-v-e5a113c8]{position:relative;display:inline-flex;justify-content:center}.tip[data-v-e5a113c8]{position:fixed;background:black;color:#fff;max-width:10rem;font-size:1.4rem;padding:.7rem 1rem;border-radius:.5rem;transform:translate(-50%);z-index:999}input[data-v-e5a113c8]{height:3rem;outline:unset;border:1px solid #e1e1e1;padding:0 .5rem;border-radius:5px;box-sizing:border-box}.html-wrapper[data-v-e5a113c8]{position:relative}.html-wrapper .mask[data-v-e5a113c8]{max-height:90rem;overflow:hidden;-webkit-mask-image:linear-gradient(180deg,#000 80%,transparent)}.html-wrapper .expand[data-v-e5a113c8]{position:absolute;z-index:1;bottom:2rem;padding:.2rem 1.5rem;border-radius:2rem;border:1px solid gray;background:white;color:gray;left:50%;transform:translate(-50%);cursor:pointer}.comment[data-v-c6281e02]{width:100%;box-sizing:border-box;margin-top:.6rem}.comment[data-v-c6281e02]:last-child{border-bottom:none}.comment.isLevelOne[data-v-c6281e02]{border-bottom:1px solid #ececec;padding:.8rem 1rem;margin-top:0}.comment.ding[data-v-c6281e02]{background:rgba(255,255,0,.3)!important}.comment.isSimple .avatar[data-v-c6281e02],.comment.isSimple .expand-line[data-v-c6281e02]{display:none}.comment.isSimple .simple-wrapper[data-v-c6281e02]{padding-left:2.8rem}.comment.isSimple .w[data-v-c6281e02]{padding-left:0!important;padding-top:.5rem}.comment .comment-content-w .more[data-v-c6281e02]{text-align:center;margin:2rem 0}.comment .comment-content[data-v-c6281e02]{display:flex;position:relative}.comment .comment-content .expand-line[data-v-c6281e02]{cursor:pointer;margin-top:.6rem;width:2.8rem;min-width:2.8rem;position:relative}.comment .comment-content .expand-line[data-v-c6281e02]:after{position:absolute;left:50%;content:" ";height:100%;width:0;border-right:1px solid #ececec}.comment .comment-content .expand-line[data-v-c6281e02]:hover:after{border-right:2px solid #0079D3}.comment .comment-content .right[data-v-c6281e02]{flex:1;width:calc(100% - 3rem)}.comment .comment-content .right .w[data-v-c6281e02]{padding-left:1rem}.comment .comment-content .right .w .post-editor-wrapper[data-v-c6281e02]{margin-top:1rem}.wrong-wrapper[data-v-c6281e02]{font-size:1.4rem;margin-bottom:1rem}.wrong-wrapper span[data-v-c6281e02]{cursor:pointer}.wrong-wrapper .del-line[data-v-c6281e02]{text-decoration:line-through}.wrong-wrapper .wrong-icon[data-v-c6281e02]{margin-left:.5rem}.wrong-wrapper .warning[data-v-c6281e02]{border-top:1px solid #e1e1e1;border-bottom:1px solid #e1e1e1;padding:1rem 0;margin-top:1rem;font-size:1.2rem;color:red}.toolbar[data-v-eaa7829b]{display:flex;align-items:center;color:#929596}.comment[data-v-63d30196]{width:100%;box-sizing:border-box;display:flex;gap:1rem;padding:1rem;border-bottom:1px solid #e2e2e2}.comment.isSimple .avatar[data-v-63d30196]{display:none}.comment.isSimple .reply_content[data-v-63d30196]{margin-top:.5rem!important}.comment .avatar[data-v-63d30196]{display:flex}.comment .avatar img[data-v-63d30196]{width:3.8rem;height:3.8rem;border-radius:.3rem}.comment .comment-body[data-v-63d30196]{flex:1;display:flex;flex-direction:column}.comment .comment-body .texts[data-v-63d30196]{display:flex;align-items:center}.comment .comment-body .reply_content[data-v-63d30196]{margin-top:1rem;max-width:calc(100% - 5rem)}.comment .isRight[data-v-63d30196]{align-items:flex-end}.comment .isRight .op[data-v-63d30196],.comment .isRight .mod[data-v-63d30196],.comment .isRight .username[data-v-63d30196]{margin:0 0 0 1rem}.comment .Author-right[data-v-63d30196]{display:flex;flex-direction:column;align-items:center}.comment .Author-right .floor[data-v-63d30196]{margin-left:0}.comment .Author-right .jump[data-v-63d30196]{color:#929596;margin-left:0}.comment .point[data-v-63d30196]{margin:0 .5rem;font-size:1.4rem;display:flex;gap:.5rem;align-items:center;font-weight:700;color:#000}.sticky{position:sticky;bottom:-2px;z-index:2}.sticky[stuck]{box-shadow:0 2px 20px #00000059!important}.v-enter-active[data-v-5fecd755],.v-leave-active[data-v-5fecd755]{transition:opacity .3s ease}.v-enter-from[data-v-5fecd755],.v-leave-to[data-v-5fecd755]{opacity:0}.username[data-v-5fecd755]{font-weight:700;font-size:1.4rem;margin-right:1rem}.op[data-v-5fecd755]{display:inline-block;background-color:transparent;color:#1484cd;border-radius:.3rem;padding:0 .3rem;cursor:default;border:2px solid #1484cd;font-size:1.2rem;font-weight:700;margin-right:1rem;transform:scale(.8)}.mod[data-v-5fecd755]{display:inline-block;background-color:transparent;color:#1484cd;border-radius:.3rem;padding:0 .3rem;cursor:default;border:2px solid #1484cd;font-size:1.2rem;font-weight:700;transform:scale(.8);background:#1484cd;color:#fff;margin-right:1rem}.my-tag[data-v-5fecd755]{font-size:1.4rem;color:red;margin-left:1rem}.my-tag:hover .remove[data-v-5fecd755]{display:inline}.my-tag .remove[data-v-5fecd755]{cursor:pointer;margin-left:.5rem;display:none}.add-tag[data-v-5fecd755]{font-size:2.4rem;transform:translateY(.1rem);line-height:1rem;display:inline-block;margin-left:1rem;cursor:pointer;position:absolute;display:none}.floor[data-v-5fecd755]{margin-left:1rem;font-size:1.2rem;line-height:1rem;border-radius:1rem;display:inline-block;background-color:#f0f0f0;color:#bdbdbd;padding:4px 12px;cursor:default}html[data-v-5fecd755],body[data-v-5fecd755]{font-size:62.5%}.flex[data-v-5fecd755]{display:flex;align-items:center;justify-content:space-between}.flex-end[data-v-5fecd755]{justify-content:flex-end}.flex-center[data-v-5fecd755]{justify-content:center}.p1[data-v-5fecd755]{padding:1rem}.p0[data-v-5fecd755]{padding:0!important}.post-author[data-v-5fecd755]{display:flex;align-items:center;position:relative;color:#ccc!important}.post-author>.username[data-v-5fecd755]{font-size:1.2rem}.sticky[data-v-5fecd755]{position:sticky;bottom:0}.sticky[stuck][data-v-5fecd755]{box-shadow:0 2px 20px #00000059}a[data-v-5fecd755]{color:#778087;text-decoration:none;cursor:pointer}a[data-v-5fecd755]:hover{text-decoration:underline}.base-loading[data-v-5fecd755]{border:2px solid;border-color:#000 #00000033 #00000033 #00000033;border-radius:100%;animation:circle-5fecd755 infinite 1s linear}.loading-c[data-v-5fecd755]{border:2px solid;border-color:#000 #00000033 #00000033 #00000033;border-radius:100%;animation:circle-5fecd755 infinite 1s linear;width:3rem;height:3rem}.loading-b[data-v-5fecd755]{border:2px solid;border-color:#000 #00000033 #00000033 #00000033;border-radius:100%;animation:circle-5fecd755 infinite 1s linear;border-color:#ffffff rgba(178,177,177,.2) rgba(178,177,177,.2) rgba(178,177,177,.2);width:3rem;height:3rem}@keyframes circle-5fecd755{0%{transform:rotate(0)}to{transform:rotate(360deg)}}.button[data-v-5fecd755]{cursor:pointer;padding:.4rem 2.4rem;border-radius:5px;display:inline-flex;justify-content:center;align-items:center;font-weight:700;font-size:1.2rem;color:#fff;background:#40a9ff;border:1px solid #40a9ff;user-select:none}.button[data-v-5fecd755]:hover{opacity:.9}.button.info[data-v-5fecd755]{color:#000;border:1px solid #40a9ff;background:white}.button.gray[data-v-5fecd755]{color:#f5f5f5;border:1px solid #b6b6b6;background:#b6b6b6}.button.light[data-v-5fecd755]{color:gray;border:1px solid #e2e2e2;background:#e2e2e2}.button[data-v-5fecd755]:before{content:" ";border:2px solid;border-color:#000 #00000033 #00000033 #00000033;border-radius:100%;animation:circle-5fecd755 infinite 1s linear;border-color:#fff transparent transparent transparent;width:1rem;height:1rem;margin-right:1rem;display:none}.button.loading[data-v-5fecd755]{cursor:not-allowed;opacity:.5}.button.loading[data-v-5fecd755]:before{display:block}.button.disabled[data-v-5fecd755]{cursor:not-allowed;color:#c6c6c6;background:#8d8d8d;border:1px solid transparent}.button.isNight[data-v-5fecd755]{color:#c6c6c6;background:#2b4054;border:1px solid transparent}.tool[data-v-5fecd755]{position:relative;margin-left:1rem;display:flex;align-items:center;font-size:1.2rem;font-weight:700;border-radius:.3rem;cursor:pointer;height:2.4rem;padding:0 .5rem}.tool[data-v-5fecd755]:before{content:" ";border:2px solid;border-color:#000 #00000033 #00000033 #00000033;border-radius:100%;animation:circle-5fecd755 infinite 1s linear;border-color:transparent #929596 #929596 #929596;width:1rem;height:1rem;margin-left:1rem;display:none}.tool.loading[data-v-5fecd755]{cursor:not-allowed;opacity:.5}.tool.loading[data-v-5fecd755]:before{display:block}.tool.loading[data-v-5fecd755]:hover{background:unset}.tool>svg[data-v-5fecd755]{width:1.6rem!important;height:1.6rem!important;margin-right:.4rem;box-sizing:border-box;border-radius:.2rem}.tool[data-v-5fecd755]:hover{background:#e8e8e8}.tool.no-hover[data-v-5fecd755]{cursor:default}.tool.no-hover[data-v-5fecd755]:hover{background:unset}.my-node[data-v-5fecd755]{border-radius:.2rem;padding:.4rem;font-size:1rem;color:#999;background:#f5f5f5;cursor:pointer}.my-node[data-v-5fecd755]:hover{text-decoration:none;background:#e2e2e2}.msgs[data-v-5fecd755]{position:fixed;margin-left:calc(50% - 25rem);width:50rem;z-index:9999;bottom:0;left:0;right:0}.msg[data-v-5fecd755]{cursor:default;margin-bottom:2rem;background:white;display:flex;color:#000;font-size:1.4rem;box-sizing:border-box;border-radius:8px;box-shadow:0 0 1rem 1px silver}.msg.success .left[data-v-5fecd755]{background:#40a9ff}.msg.warning .left[data-v-5fecd755]{background:#c8c002}.msg.error .left[data-v-5fecd755]{background:red}.msg .left[data-v-5fecd755]{border-radius:8px 0 0 8px;display:flex;align-items:center;background:#40a9ff}.msg .left svg[data-v-5fecd755]{margin:0 .3rem;cursor:pointer}.msg .right[data-v-5fecd755]{flex:1;padding:1rem 2rem;display:flex;justify-content:space-between;align-items:center}.line[data-v-5fecd755]{border-bottom:1px solid #e2e2e2}.my-box[data-v-5fecd755]{box-shadow:0 2px 3px #0000001a;box-shadow:#00000014 0 4px 12px;border-radius:var(--box-border-radius);background:white;margin-bottom:2rem;width:100%;overflow:hidden;box-sizing:border-box}.my-cell[data-v-5fecd755]{padding:.6rem 1rem;font-size:1.4rem;line-height:150%;text-align:left;border-bottom:1px solid #e2e2e2}.f14[data-v-5fecd755]{font-size:1.4rem}.switch[data-v-5fecd755]{width:4.5rem;height:2rem;border-radius:2rem;position:relative;display:flex;align-items:center;transition:all .3s}.switch.light[data-v-5fecd755]{border:1px solid #e2e2e2}.switch.light.active[data-v-5fecd755]{background:#e2e2e2}.switch.light.active[data-v-5fecd755]:before{right:.2rem;background:white}.switch.light[data-v-5fecd755]:before{background:#e2e2e2}.switch.gray[data-v-5fecd755]{border:1px solid #ccc}.switch.gray.active[data-v-5fecd755]{background:#ccc}.switch.gray.active[data-v-5fecd755]:before{right:.2rem;background:white}.switch.gray[data-v-5fecd755]:before{background:#ccc}.switch.isNight[data-v-5fecd755]{border:1px solid #31475e}.switch.isNight.active[data-v-5fecd755]{background:#31475e}.switch.isNight.active[data-v-5fecd755]:before{right:.2rem;background:gray}.switch.isNight[data-v-5fecd755]:before{background:#31475e}.switch[data-v-5fecd755]:before{position:absolute;content:" ";transition:all .3s;right:calc(100% - 2rem);width:1.8rem;height:1.8rem;border-radius:50%}.modal[data-v-5fecd755]{position:fixed;z-index:100;width:100vw;height:100vh;left:0;top:0;display:flex;justify-content:center;align-items:center}.modal .title[data-v-5fecd755]{font-size:2.4rem;margin-bottom:1rem;text-align:center}.modal .option[data-v-5fecd755]{display:flex;justify-content:space-between;align-items:center;padding:.6rem 0}.modal .option>span[data-v-5fecd755]{position:relative}.modal .mask[data-v-5fecd755]{position:fixed;width:100vw;height:100vh;left:0;top:0;background:rgba(0,0,0,.3)}.radio-group2[data-v-5fecd755]{display:inline-flex;border-radius:.5rem;overflow:hidden;border:1px solid #e2e2e2}.radio-group2 .radio[data-v-5fecd755]{cursor:pointer;background:transparent;padding:.3rem 1rem;border-left:1px solid #e2e2e2;color:#9ca1a4;font-size:1.2rem}.radio-group2 .radio[data-v-5fecd755]:first-child{border-left:none}.radio-group2 .active[data-v-5fecd755]{background:#e2e2e2;color:gray}.radio-group2.isNight[data-v-5fecd755]{border:1px solid #454847}.radio-group2.isNight .radio[data-v-5fecd755]{border-left:1px solid #454847;color:#fff}.radio-group2.isNight .active[data-v-5fecd755]{background:#31475e}.pop-confirm[data-v-5fecd755]{position:relative;display:inline-flex;justify-content:center}.tip[data-v-5fecd755]{position:fixed;background:black;color:#fff;max-width:10rem;font-size:1.4rem;padding:.7rem 1rem;border-radius:.5rem;transform:translate(-50%);z-index:999}input[data-v-5fecd755]{height:3rem;outline:unset;border:1px solid #e1e1e1;padding:0 .5rem;border-radius:5px;box-sizing:border-box}.Post[data-v-5fecd755]{position:unset!important;background:transparent!important;overflow:unset!important}.Post .main[data-v-5fecd755]{background:transparent!important;padding:unset!important;width:100%!important}.Post .close-btn[data-v-5fecd755]{display:none}.post-detail[data-v-5fecd755]{text-align:start;position:fixed;z-index:99;left:0;right:0;bottom:0;top:0;background:rgba(46,47,48,.8);overflow:auto;font-size:1.4rem;display:flex;justify-content:center;flex-wrap:wrap}.post-detail[data-v-5fecd755] .subtle{background-color:#ecfdf5e6;border-left:4px solid #a7f3d0}.post-detail.isNight[data-v-5fecd755]{background:transparent;backdrop-filter:blur(10px)}.post-detail.isNight .main[data-v-5fecd755]{background:transparent;padding:3rem 1rem 15rem}.post-detail.isNight .main .toolbar-wrapper[data-v-5fecd755]{border-top:unset!important}.post-detail.isNight .main .button.gray[data-v-5fecd755]{background:rgba(14,14,15,.9)!important;border:1px solid rgba(14,14,15,.9)!important}.post-detail.isNight .main .relationReply[data-v-5fecd755]{color:#fff}.post-detail.isNight .main .relationReply .comments[data-v-5fecd755],.post-detail.isNight .main .relationReply .my-cell[data-v-5fecd755]{background:rgba(14,14,15,.9)}.post-detail.isNight .main .relationReply .comment[data-v-5fecd755]{border-bottom:1px solid rgba(84,84,88,.6)}.post-detail.isNight .main .my-box[data-v-5fecd755]{color:#fff;background:rgba(14,14,15,.9)}.post-detail.isNight .main .my-box .title[data-v-5fecd755],.post-detail.isNight .main .my-box .content[data-v-5fecd755]{color:#d1d5d9!important}.post-detail.isNight .main .my-box .base-info[data-v-5fecd755],.post-detail.isNight .main .my-box .content[data-v-5fecd755]{border:1px solid #22303f!important}.post-detail.isNight .main[data-v-5fecd755] .subtle{background-color:#1c1c1ee6;border-left:4px solid #047857}.post-detail.isNight .main .my-cell[data-v-5fecd755]{border-bottom:1px solid #22303f!important}.post-detail.isNight .main[data-v-5fecd755] .isLevelOne{border-bottom:1px solid rgba(84,84,88,.6)}.post-detail.isNight .main[data-v-5fecd755] .comment .expand-line:after{border-right:1px solid rgba(84,84,88,.6)!important}.post-detail.isNight .main[data-v-5fecd755] .comment .expand-line:hover:after{border-right:2px solid #0079D3!important}.post-detail.isNight .main[data-v-5fecd755] .comment .comment-content .w>.text{color:#d1d5d9!important}.post-detail.isNight .main[data-v-5fecd755] .Author-right .toolbar:hover{background:rgba(14,14,15,.9)!important}.post-detail.isNight .main[data-v-5fecd755] .Author-right .tool{background:#22303f!important}.post-detail.isNight .main[data-v-5fecd755] .point svg:hover{background:#22303f}.post-detail.isNight .main[data-v-5fecd755] .point .num{color:#d1d5d9!important}.post-detail.isNight .main[data-v-5fecd755] .floor{background:#393f4e!important;color:#d1d5d9!important}.post-detail.isNight .main[data-v-5fecd755] .post-editor-wrapper .post-editor{background:rgba(28,28,30,.9);border:transparent;color:#fff}.post-detail.isNight .main .call-list[data-v-5fecd755]{background:#22303f}.post-detail.isNight .main .call-list .call-item[data-v-5fecd755]{border-top:1px solid rgba(14,14,15,.9)}.post-detail.isNight .main .call-list .call-item .select[data-v-5fecd755],.post-detail.isNight .main .call-list .call-item[data-v-5fecd755]:hover,.post-detail.isNight .main .call-list .call-item.select[data-v-5fecd755]{background-color:#393f4e;text-decoration:none}.post-detail.isNight .main .scroll-to[data-v-5fecd755],.post-detail.isNight .main .close-btn[data-v-5fecd755],.post-detail.isNight .main .scroll-top[data-v-5fecd755],.post-detail.isNight .main .top-reply[data-v-5fecd755]{background:rgba(0,0,0,.6);color:#9caec7}.post-detail.isNight .main .scroll-to input[data-v-5fecd755]{background:rgba(28,28,30,.9);border:1px solid rgba(84,84,88,.6);color:#d1d5d9}.post-detail.isNight .main[data-v-5fecd755] .tool:hover{background-color:#22303f!important}.post-detail .main[data-v-5fecd755]{display:flex;justify-content:flex-end;padding:3rem 8rem 15rem;background:#e2e2e2;position:relative;outline:none}.post-detail .main .main-wrapper[data-v-5fecd755]{width:77rem;padding-bottom:2rem;display:flex;flex-direction:column;align-items:center;position:relative}.post-detail .main .main-wrapper .post-wrapper .toolbar-wrapper[data-v-5fecd755]{border-top:1px solid #e2e2e2;height:3.4rem;padding-left:.6rem;display:flex;align-items:center}.post-detail .main .main-wrapper .editor-wrapper .float[data-v-5fecd755]{margin-right:2rem}.post-detail .main .main-wrapper .editor-wrapper .w[data-v-5fecd755]{padding:1.2rem}.post-detail .main .main-wrapper .comment-wrapper .comments[data-v-5fecd755]{width:100%;box-sizing:border-box}.post-detail .main .main-wrapper .loading-wrapper[data-v-5fecd755]{height:20rem;display:flex;justify-content:center;align-items:center}.post-detail .main .main-wrapper #no-comments-yet[data-v-5fecd755]{color:#a9a9a9;font-weight:700;text-align:center;width:100%;margin-bottom:2rem;box-sizing:border-box}.post-detail .main .relationReply[data-v-5fecd755]{position:fixed;width:25vw;top:6.5rem;bottom:15rem;z-index:99;transform:translate(calc(100% + 2rem));font-size:2rem;overflow:hidden}.post-detail .main .relationReply .my-cell[data-v-5fecd755]{background:white;border-radius:.5rem .5rem 0 0}.post-detail .main .relationReply .comments[data-v-5fecd755]{max-height:calc(100% - 4.2rem);overflow:auto;background:white;border-radius:0 0 .5rem .5rem}.post-detail .main .call-list[data-v-5fecd755]{z-index:9;position:absolute;top:12rem;border:1px solid #ccc;background-color:#fff;box-shadow:0 5px 15px #0000001a;overflow:hidden;max-height:30rem;min-width:8rem;box-sizing:content-box}.post-detail .main .call-list .call-item[data-v-5fecd755]{border-top:1px solid #ccc;height:3rem;display:flex;padding:0 1rem;align-items:center;cursor:pointer;font-size:14px;box-sizing:border-box}.post-detail .main .call-list .call-item .select[data-v-5fecd755],.post-detail .main .call-list .call-item[data-v-5fecd755]:hover,.post-detail .main .call-list .call-item.select[data-v-5fecd755]{background-color:#f0f0f0;text-decoration:none}.post-detail .main .call-list .call-item[data-v-5fecd755]:nth-child(1){border-top:1px solid transparent}@media screen and (max-width: 1500px){.post-detail .main-wrapper[data-v-5fecd755]{width:65vw!important}}@media screen and (max-width: 1280px){.post-detail .main-wrapper[data-v-5fecd755]{width:75vw!important}}.post-detail .scroll-top[data-v-5fecd755]{position:fixed;bottom:10rem;z-index:99;padding:.6rem .2rem;width:3.5rem;transform:translate(6rem);font-size:2rem;background:#f1f1f1;border:none;color:#a9a9a9}.post-detail .scroll-to[data-v-5fecd755]{position:fixed;bottom:10rem;z-index:99;padding:.6rem .2rem;width:3.5rem;transform:translate(6rem);font-size:2rem;background:#f1f1f1;border:none;color:#a9a9a9;bottom:15rem;display:flex;flex-direction:column}.post-detail .scroll-to input[data-v-5fecd755]{margin-top:.5rem;height:2rem;width:3.3rem;font-size:1.4rem;text-align:center;color:gray}.post-detail .read-notice[data-v-5fecd755]{display:flex;align-items:center;color:gray}.post-detail .read-notice .jump[data-v-5fecd755]{background:#f1f1f1;color:gray;padding:.3rem 1rem;border-radius:.4rem;margin:0 1rem;cursor:pointer}.post-detail .close-btn[data-v-5fecd755]{color:#b6b6b6;cursor:pointer;position:fixed;top:3rem;transform:translate(4rem);font-size:2rem}.post-detail .top-reply[data-v-5fecd755]{color:#e2e2e2;cursor:pointer;font-size:2rem;display:flex}.post-detail .top-reply i[data-v-5fecd755]{padding:0 1rem}.isNight[data-v-b42546ed]{background:#22303f!important;color:#ccc!important}.base64_tooltip[data-v-b42546ed]{box-shadow:0 3px 6px -4px #0000001f,0 6px 16px #00000014,0 9px 28px 8px #0000000d;background:white;min-height:2.2rem;max-width:20rem;padding:.8rem;position:fixed;z-index:9998;display:flex;align-items:center;border-radius:.5rem;cursor:pointer;line-break:anywhere;font-size:1.4rem;color:#000}.base64_tooltip svg[data-v-b42546ed]{margin-left:1rem;min-width:1.8rem}.base64_tooltip .button[data-v-b42546ed]{margin-top:1rem;margin-left:2rem}.isNight .wrapper[data-v-6683a3c1]{background:#22303f!important}.isNight .wrapper .title[data-v-6683a3c1]{color:gray}.isNight .wrapper .option[data-v-6683a3c1]{color:#fff!important}.isNight .wrapper .option span[data-v-6683a3c1]{color:gray!important}.isNight .wrapper .white[data-v-6683a3c1]{color:#fff!important}.tag-modal .wrapper[data-v-6683a3c1]{z-index:9;background:#f1f1f1;border-radius:.8rem;font-size:1.4rem;padding:2rem 6rem 4rem;width:25rem}.tag-modal .wrapper .btns[data-v-6683a3c1]{margin-top:1.5rem;display:flex;justify-content:flex-end;align-items:center;gap:1.5rem;font-size:1rem}.tag-modal .wrapper .btns div[data-v-6683a3c1]{cursor:pointer}.tag-modal .wrapper .btns .main[data-v-6683a3c1]{color:gray;background:#e2e2e2;padding:.5rem 1.2rem;border-radius:.4rem}.msgs[data-v-868aa501]{position:fixed;margin-left:calc(50% - 25rem);width:50rem;z-index:9999;bottom:0;left:0;right:0}.isNight .open-post[data-v-c60de789],.isNight .nav[data-v-c60de789]{color:#fff;background:rgba(34,34,36,.8);border-bottom:none}.isNight .target-user-tags[data-v-c60de789]{background:rgba(14,14,15,.8);box-shadow:none;border:none;color:var(--box-foreground-color);border-bottom-right-radius:8px;border-bottom-left-radius:8px}.nav[data-v-c60de789]{font-size:1.4rem;background:white;padding:1rem;border-bottom:1px solid #e2e2e2}.target-user-tags[data-v-c60de789]{font-size:1.4rem;background:white;padding:1rem;border-bottom:1px solid #e2e2e2;word-break:break-all;text-align:start;box-shadow:0 2px 3px #0000001a;border-bottom-left-radius:3px;border-bottom-right-radius:3px}.target-user-tags .add-tag[data-v-c60de789]{display:inline-block}.list-switch[data-v-c60de789]{padding:0!important;position:relative}.list-switch>.radio-group2[data-v-c60de789]{position:absolute;display:block;left:-6rem}.list-switch>.radio-group2 .radio[data-v-c60de789]{board:none} ');
...
(function (vue) {
  ...
  const _withScopeId$9 = (n2) => (vue.pushScopeId("data-v-afbd285a"), n2 = n2(), vue.popScopeId(), n2);
  const _hoisted_1$e = { class: "wrapper" };
  const _hoisted_2$d = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "title" }, " 脚本设置 ", -1));
  const _hoisted_3$a = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "sub-title" }, " 设置自动保存到本地，下次打开依然生效 ", -1));
  const _hoisted_4$9 = { class: "body" };
  const _hoisted_5$8 = { class: "option-list" };
  const _hoisted_6$8 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "option-title" }, "列表:", -1));
  const _hoisted_7$7 = { class: "option" };
  const _hoisted_8$7 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("span", null, "列表帖子展示方式：", -1));
  const _hoisted_9$6 = { class: "option" };
  const _hoisted_10$6 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("span", null, "列表hover时显示预览按钮：", -1));
  const _hoisted_11$6 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "notice" }, " 此项需要刷新页面才能生效 ", -1));
  const _hoisted_12$6 = { class: "option" };
  const _hoisted_13$6 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("span", null, "点击列表的帖子，打开详情弹框 ：", -1));
  const _hoisted_14$6 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "notice" }, " 若关闭此项，点击列表的帖子时，不会打开弹框，会跳转网页 ", -1));
  const _hoisted_15$6 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "option-title" }, "帖子:", -1));
  const _hoisted_16$5 = { class: "option" };
  const _hoisted_17$5 = { class: "option" };
  const _hoisted_18$5 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("span", null, "单独打开帖子时默认显示楼中楼 ：", -1));
  const _hoisted_19$4 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "notice" }, " 单独打开这种地址 https://v2ex.com/t/xxxx 时，是否默认显示楼中楼 ", -1));
  const _hoisted_20$4 = { class: "option" };
  const _hoisted_21$3 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("span", null, "点击左右两侧透明处关闭帖子详情弹框：", -1));
  const _hoisted_22$3 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "option-title" }, "点赞:", -1));
  const _hoisted_23$3 = { class: "option" };
  const _hoisted_24$2 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("span", null, "显示高赞回复：", -1));
  const _hoisted_25$3 = { class: "option" };
  const _hoisted_26$2 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("span", null, "最多显示多少个高赞回复：", -1));
  const _hoisted_27$1 = { class: "option" };
  const _hoisted_28$1 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("span", null, "最少需要多少赞才能被判定为高赞：", -1));
  const _hoisted_29$1 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "option-title" }, "记忆阅读:", -1));
  const _hoisted_30$1 = { class: "option" };
  const _hoisted_31$1 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("span", null, "记录上次阅读楼层（误差1层左右）：", -1));
  const _hoisted_32$1 = { class: "option" };
  const _hoisted_33$1 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("span", null, "打开帖子自动跳转到上次阅读楼层：", -1));
  const _hoisted_34$1 = { class: "option-list" };
  const _hoisted_35$1 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "option-title" }, "其他:", -1));
  const _hoisted_36$1 = { class: "option" };
  const _hoisted_37 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("span", null, "显示工具栏：", -1));
  const _hoisted_38 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "notice" }, [
  ...
  const _hoisted_39 = { class: "option" };
  const _hoisted_40 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("span", null, "新标签页打开链接 ：", -1));
  const _hoisted_41 = { class: "option" };
  const _hoisted_42 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("span", null, "用户打标签(跨平台，数据保存在自己的记事本)：", -1));
  const _hoisted_43 = { class: "option" };
  const _hoisted_44 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("span", null, "正文超长自动折叠：", -1));
  const _hoisted_45 = { class: "option" };
  const _hoisted_46 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("span", null, "划词显示Base64解码框：", -1));
  const _hoisted_47 = { class: "option" };
  const _hoisted_48 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("span", null, "使用 SOV2EX 搜索：", -1));
  const _hoisted_49 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "notice" }, " 此项需要刷新页面才能生效 ", -1));
  const _hoisted_50 = { class: "option" };
  const _hoisted_51 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("span", null, "帖子宽度：", -1));
  const _hoisted_52 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "notice" }, [
  ...
  const _hoisted_53 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "notice" }, " 提示：此项设置以后，单独打开详情页时会出现帖子突然变宽（窄）的问题，暂时无解 ", -1));
  const _hoisted_54 = { class: "option" };
  const _hoisted_55 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("span", null, "自动签到：", -1));
  const _hoisted_56 = { class: "option" };
  const _hoisted_57 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("span", null, "自定义背景：", -1));
  const _hoisted_58 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "notice" }, [
  ...
  const _hoisted_59 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "notice" }, " 此项需要刷新页面才能生效 ", -1));
  const _hoisted_60 = { class: "option" };
  const _hoisted_61 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("span", null, "收藏时提醒添加到书签：", -1));
  const _hoisted_62 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "notice" }, " V站的帐号一旦被封了，就无法登录了，账号里的收藏也就看不到了 ", -1));
  const _hoisted_63 = { class: "option" };
  const _hoisted_64 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "notice" }, " 此项需要刷新页面才能生效 ", -1));
            ...
            vue.createElementVNode("div", _hoisted_4$9, [
              vue.createElementVNode("div", _hoisted_5$8, [
                ...
                vue.createElementVNode("div", _hoisted_12$6, [
                  ...
                  vue.createElementVNode("div", {
                    ...
                    onClick: _cache[4] || (_cache[4] = ($event) => {
                      $data.config.clickPostItemOpenDetail = !$data.config.clickPostItemOpenDetail;
                      $data.config.newTabOpen = !$data.config.clickPostItemOpenDetail;
                    })
                  }, null, 2)
                ]),
                _hoisted_14$6,
                ...
                vue.createElementVNode("div", _hoisted_16$5, [
                  vue.createElementVNode("span", {
                    class: vue.normalizeClass($options.isNew && "new")
                  }, "回复展示方式：", 2),
                  vue.createElementVNode("div", {
                    class: vue.normalizeClass(["radio-group2", { isNight: $options.isNight }])
                  }, [
                    vue.createVNode(_component_Tooltip, { title: "不隐藏@用户" }, {
                      default: vue.withCtx(() => [
                        vue.createElementVNode("div", {
                          ...
                          onClick: _cache[5] || (_cache[5] = ($event) => $data.config.commentDisplayType = $options.CommentDisplayType.FloorInFloor)
                        }, "楼中楼(@) ", 2)
                      ]),
                      _: 1
                    }),
                    vue.createVNode(_component_Tooltip, { title: "隐藏第一个@用户，双击内容可显示原文" }, {
                      default: vue.withCtx(() => [
                        vue.createElementVNode("div", {
                          ...
                          onClick: _cache[6] || (_cache[6] = ($event) => $data.config.commentDisplayType = $options.CommentDisplayType.FloorInFloorNoCallUser)
                        }, "楼中楼 ", 2)
                      ]),
                      _: 1
                    }),
                    vue.createVNode(_component_Tooltip, { title: "重复显示楼中楼的回复" }, {
                      default: vue.withCtx(() => [
                        vue.createElementVNode("div", {
                          ...
                          onClick: _cache[7] || (_cache[7] = ($event) => $data.config.commentDisplayType = $options.CommentDisplayType.FloorInFloorNested)
                        }, "冗余楼中楼 ", 2)
                      ]),
                      _: 1
                    }),
                    vue.createElementVNode("div", {
                      ...
                      onClick: _cache[8] || (_cache[8] = ($event) => $data.config.commentDisplayType = $options.CommentDisplayType.Like)
                    }, "感谢 ", 2),
                    vue.createElementVNode("div", {
                      class: vue.normalizeClass(["radio", $data.config.commentDisplayType === $options.CommentDisplayType.OnlyOp ? "active" : ""]),
                      onClick: _cache[9] || (_cache[9] = ($event) => $data.config.commentDisplayType = $options.CommentDisplayType.OnlyOp)
                    }, "只看楼主 ", 2),
                    vue.createElementVNode("div", {
                      class: vue.normalizeClass(["radio", $data.config.commentDisplayType === $options.CommentDisplayType.V2exOrigin ? "active" : ""]),
                      onClick: _cache[10] || (_cache[10] = ($event) => $data.config.commentDisplayType = $options.CommentDisplayType.V2exOrigin)
                    }, "V2原版 ", 2)
                  ], 2)
                ]),
  ...
  const Setting = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["render", _sfc_render$8], ["__scopeId", "data-v-afbd285a"]]);
  const eventBus = {
  ...
  const _hoisted_4$8 = { class: "options" };
  ...
  const PopConfirm = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["render", _sfc_render$7], ["__scopeId", "data-v-46b6bc70"]]);
  ...
  const Point = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["render", _sfc_render$6], ["__scopeId", "data-v-97e3a46a"]]);
  const _sfc_main$b = {
    name: "Author",
  ...
  const _withScopeId$8 = (n2) => (vue.pushScopeId("data-v-2730d0b7"), n2 = n2(), vue.popScopeId(), n2);
  const _hoisted_1$b = { class: "Author-left" };
  const _hoisted_2$a = /* @__PURE__ */ _withScopeId$8(() => /* @__PURE__ */ vue.createElementVNode("path", {
    d: "M22 42H6V26",
    stroke: "#177EC9",
    "stroke-width": "4",
    "stroke-linecap": "round",
  ...
  const _hoisted_3$7 = /* @__PURE__ */ _withScopeId$8(() => /* @__PURE__ */ vue.createElementVNode("path", {
    d: "M26 6H42V22",
    stroke: "#177EC9",
    "stroke-width": "4",
    "stroke-linecap": "round",
  ...
  const _hoisted_14$5 = /* @__PURE__ */ _withScopeId$8(() => /* @__PURE__ */ vue.createElementVNode("i", { class: "fa fa-tag" }, null, -1));
  ...
  const _hoisted_18$4 = /* @__PURE__ */ _withScopeId$8(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "tool" }, [
    /* @__PURE__ */ vue.createElementVNode("span", null, "隐藏")
  ], -1));
  const _hoisted_19$3 = /* @__PURE__ */ _withScopeId$8(() => /* @__PURE__ */ vue.createElementVNode("span", null, "上下文", -1));
  const _hoisted_20$3 = [
    _hoisted_19$3
  ];
  const _hoisted_21$2 = /* @__PURE__ */ _withScopeId$8(() => /* @__PURE__ */ vue.createElementVNode("span", null, "跳转", -1));
  const _hoisted_22$2 = [
    _hoisted_21$2
  ];
  const _hoisted_23$2 = /* @__PURE__ */ vue.createStaticVNode('<svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-2730d0b7><path d="M4 6H44V36H29L24 41L19 36H4V6Z" fill="none" stroke="#929596" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-2730d0b7></path><path d="M23 21H25.0025" stroke="#929596" stroke-width="2" stroke-linecap="round" data-v-2730d0b7></path><path d="M33.001 21H34.9999" stroke="#929596" stroke-width="2" stroke-linecap="round" data-v-2730d0b7></path><path d="M13.001 21H14.9999" stroke="#929596" stroke-width="2" stroke-linecap="round" data-v-2730d0b7></path></svg><span data-v-2730d0b7>回复</span>', 2);
  const _hoisted_25$2 = [
    _hoisted_23$2
  ];
    ...
    return vue.openBlock(), vue.createElementBlock("div", {
      ...
      vue.createElementVNode("div", _hoisted_1$b, [
        !$props.modelValue ? (vue.openBlock(), vue.createElementBlock("svg", {
          ...
          fill: "none",
          xmlns: "http://www.w3.org/2000/svg"
        }, _hoisted_4$7)) : vue.createCommentVNode("", true),
        ...
        vue.createElementVNode("span", _hoisted_7$6, [
          vue.createElementVNode("strong", null, [
            vue.createElementVNode("a", {
              href: `/member/${$props.comment.username}`,
              class: "username"
            }, vue.toDisplayString($props.comment.username), 9, _hoisted_8$6)
          ]),
  ...
  const Author = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$5], ["__scopeId", "data-v-2730d0b7"]]);
  const _withScopeId$7 = (n2) => (vue.pushScopeId("data-v-7ff2843d"), n2 = n2(), vue.popScopeId(), n2);
  const _hoisted_1$a = { class: "get-cursor" };
  const _hoisted_2$9 = ["innerHTML"];
  const _hoisted_3$6 = { class: "toolbar" };
  const _hoisted_4$6 = { class: "left" };
  const _hoisted_5$6 = /* @__PURE__ */ _withScopeId$7(() => /* @__PURE__ */ vue.createElementVNode("path", {
  ...
  const _hoisted_6$6 = /* @__PURE__ */ _withScopeId$7(() => /* @__PURE__ */ vue.createElementVNode("path", {
  ...
  const _hoisted_7$5 = /* @__PURE__ */ _withScopeId$7(() => /* @__PURE__ */ vue.createElementVNode("path", {
    d: "M31 18V22",
    stroke: "#929596",
    "stroke-width": "2",
    "stroke-linecap": "round",
  ...
  const _hoisted_8$5 = /* @__PURE__ */ _withScopeId$7(() => /* @__PURE__ */ vue.createElementVNode("path", {
    d: "M17 18V22",
    stroke: "#929596",
    "stroke-width": "2",
    "stroke-linecap": "round",
  ...
  const _hoisted_11$4 = /* @__PURE__ */ _withScopeId$7(() => /* @__PURE__ */ vue.createElementVNode("svg", {
    width: "20",
    height: "20",
    viewBox: "0 0 48 48",
    fill: "none",
  ...
  const _hoisted_14$4 = /* @__PURE__ */ _withScopeId$7(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "title" }, "经典表情", -1));
  ...
  const _sfc_main$a = {
    ...
    setup(__props, { expose, emit: emits }) {
      ...
      expose({ content, isFocus: () => isFocus.value });
  ...
  const PostEditor = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-7ff2843d"]]);
  const _hoisted_1$9 = {
    key: 0,
    class: "html-wrapper"
  };
  ...
  const BaseHtmlRender = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-e5a113c8"]]);
  const _sfc_main$8 = {
    name: "Comment",
  ...
  const _withScopeId$6 = (n2) => (vue.pushScopeId("data-v-c6281e02"), n2 = n2(), vue.popScopeId(), n2);
  ...
  const _hoisted_10$3 = /* @__PURE__ */ _withScopeId$6(() => /* @__PURE__ */ vue.createElementVNode("br", null, null, -1));
  const _hoisted_11$3 = /* @__PURE__ */ _withScopeId$6(() => /* @__PURE__ */ vue.createElementVNode("br", null, null, -1));
  const _hoisted_12$3 = /* @__PURE__ */ _withScopeId$6(() => /* @__PURE__ */ vue.createElementVNode("br", null, null, -1));
  const _hoisted_13$3 = /* @__PURE__ */ _withScopeId$6(() => /* @__PURE__ */ vue.createElementVNode("br", null, null, -1));
  ...
  const Comment = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$4], ["__scopeId", "data-v-c6281e02"]]);
  const _sfc_main$7 = {
    name: "Toolbar",
    inject: [
      "isLogin",
  ...
  const _withScopeId$5 = (n2) => (vue.pushScopeId("data-v-eaa7829b"), n2 = n2(), vue.popScopeId(), n2);
  const _hoisted_1$7 = { class: "toolbar" };
  const _hoisted_2$6 = /* @__PURE__ */ vue.createStaticVNode('<svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-eaa7829b><path d="M4 6H44V36H29L24 41L19 36H4V6Z" fill="none" stroke="#929596" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-eaa7829b></path><path d="M23 21H25.0025" stroke="#929596" stroke-width="2" stroke-linecap="round" data-v-eaa7829b></path><path d="M33.001 21H34.9999" stroke="#929596" stroke-width="2" stroke-linecap="round" data-v-eaa7829b></path><path d="M13.001 21H14.9999" stroke="#929596" stroke-width="2" stroke-linecap="round" data-v-eaa7829b></path></svg><span data-v-eaa7829b>回复</span>', 2);
  const _hoisted_4$4 = [
    _hoisted_2$6
  ];
  const _hoisted_5$4 = {
  ...
  const _hoisted_8$3 = /* @__PURE__ */ _withScopeId$5(() => /* @__PURE__ */ vue.createElementVNode("svg", {
    viewBox: "0 0 48 48",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
  }, [
  ...
  const _hoisted_9$2 = /* @__PURE__ */ _withScopeId$5(() => /* @__PURE__ */ vue.createElementVNode("span", null, "Tweet", -1));
  const _hoisted_10$2 = [
    _hoisted_8$3,
    _hoisted_9$2
  ];
  ...
  const _hoisted_15$2 = /* @__PURE__ */ vue.createStaticVNode('<svg width="19" height="19" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-eaa7829b><path d="M36 35H12V21C12 14.3726 17.3726 9 24 9C30.6274 9 36 14.3726 36 21V35Z" fill="#929596" stroke="#929596" stroke-width="4" stroke-linejoin="round" data-v-eaa7829b></path><path d="M8 42H40" stroke="#929596" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" data-v-eaa7829b></path><path d="M4 13L7 14" stroke="#929596" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" data-v-eaa7829b></path><path d="M13 3.9999L14 6.9999" stroke="#929596" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" data-v-eaa7829b></path><path d="M10.0001 9.99989L7.00009 6.99989" stroke="#929596" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" data-v-eaa7829b></path></svg>', 1);
  ...
  const Toolbar = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$3], ["__scopeId", "data-v-eaa7829b"]]);
  const _withScopeId$4 = (n2) => (vue.pushScopeId("data-v-63d30196"), n2 = n2(), vue.popScopeId(), n2);
  ...
  const _hoisted_5$3 = /* @__PURE__ */ _withScopeId$4(() => /* @__PURE__ */ vue.createElementVNode("svg", {
    width: "19",
    height: "19",
    viewBox: "0 0 48 48",
    fill: "none"
  ...
  const _hoisted_8$2 = /* @__PURE__ */ _withScopeId$4(() => /* @__PURE__ */ vue.createElementVNode("i", { class: "fa fa-tag" }, null, -1));
  const _hoisted_9$1 = {
    key: 2,
    class: "ago"
  };
  ...
  const _hoisted_17$1 = /* @__PURE__ */ _withScopeId$4(() => /* @__PURE__ */ vue.createElementVNode("i", { class: "fa fa-tag" }, null, -1));
  const _hoisted_18$1 = {
    key: 9,
    class: "point"
  };
  const _hoisted_19$1 = /* @__PURE__ */ _withScopeId$4(() => /* @__PURE__ */ vue.createElementVNode("svg", {
    width: "19",
    height: "19",
    viewBox: "0 0 48 48",
    fill: "none"
  ...
  const _hoisted_25$1 = /* @__PURE__ */ _withScopeId$4(() => /* @__PURE__ */ vue.createElementVNode("span", null, "跳转", -1));
  const _hoisted_26$1 = [
    _hoisted_25$1
  ];
  const _sfc_main$6 = {
        ...
        return vue.openBlock(), vue.createElementBlock("div", {
          ...
          vue.createElementVNode("div", {
            ...
            vue.createElementVNode("div", _hoisted_3$4, [
              __props.comment.thankCount && __props.isRight ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_4$3, [
                _hoisted_5$3,
  ...
  const SingleComment = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-63d30196"]]);
      ...
      modelValue: {
        handler(newVal) {
          ...
          if (newVal) {
            ...
            if ((this.pageType === PageType.Home || this.pageType === PageType.Node || this.pageType === PageType.Member) && window.location.pathname !== "/") {
              window.history.back();
            }
          }
        }
  ...
  const _withScopeId$3 = (n2) => (vue.pushScopeId("data-v-5fecd755"), n2 = n2(), vue.popScopeId(), n2);
  ...
  const _hoisted_4$2 = { class: "my-cell flex" };
  const _hoisted_5$2 = /* @__PURE__ */ _withScopeId$3(() => /* @__PURE__ */ vue.createElementVNode("span", { class: "gray" }, "高赞回复", -1));
  const _hoisted_6$2 = { class: "top-reply" };
  const _hoisted_7$1 = /* @__PURE__ */ _withScopeId$3(() => /* @__PURE__ */ vue.createElementVNode("i", { class: "fa fa-times" }, null, -1));
  const _hoisted_8$1 = { ref: "topReply" };
  ...
  const _hoisted_12 = /* @__PURE__ */ _withScopeId$3(() => /* @__PURE__ */ vue.createElementVNode("span", null, "上次打开：", -1));
  const _hoisted_13 = /* @__PURE__ */ _withScopeId$3(() => /* @__PURE__ */ vue.createElementVNode("i", { class: "fa fa-long-arrow-down" }, null, -1));
  const _hoisted_14 = [
    _hoisted_13
  ];
  const _hoisted_15 = /* @__PURE__ */ _withScopeId$3(() => /* @__PURE__ */ vue.createElementVNode("i", { class: "fa fa-long-arrow-down" }, null, -1));
  const _hoisted_16 = [
    _hoisted_15
  ];
  ...
  const _hoisted_20 = /* @__PURE__ */ _withScopeId$3(() => /* @__PURE__ */ vue.createElementVNode("strong", { class: "snow" }, "•", -1));
  ...
  const _hoisted_26 = /* @__PURE__ */ _withScopeId$3(() => /* @__PURE__ */ vue.createElementVNode("span", null, "添加一条新回复", -1));
  const _hoisted_27 = { class: "notice-right" };
  const _hoisted_28 = { class: "w" };
  const _hoisted_29 = /* @__PURE__ */ _withScopeId$3(() => /* @__PURE__ */ vue.createElementVNode("span", { class: "gray" }, "上下文", -1));
  const _hoisted_30 = { class: "top-reply" };
  const _hoisted_31 = ["onClick"];
  const _hoisted_32 = /* @__PURE__ */ _withScopeId$3(() => /* @__PURE__ */ vue.createElementVNode("i", {
    class: "fa fa-times",
    "aria-hidden": "true"
  }, null, -1));
  const _hoisted_33 = [
  ...
  const _hoisted_34 = /* @__PURE__ */ _withScopeId$3(() => /* @__PURE__ */ vue.createElementVNode("i", {
  ...
  const _hoisted_36 = /* @__PURE__ */ _withScopeId$3(() => /* @__PURE__ */ vue.createElementVNode("i", { class: "fa fa-long-arrow-down" }, null, -1));
              ...
              $options.config.showToolbar ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_10, [
                vue.createElementVNode("div", {
                  ...
                  vue.createVNode(_component_Tooltip, { title: "不隐藏@用户" }, {
                    default: vue.withCtx(() => [
                      vue.createElementVNode("div", {
                        ...
                        onClick: _cache[4] || (_cache[4] = ($event) => $options.changeOption($options.CommentDisplayType.FloorInFloor))
                      }, "楼中楼(@) ", 2)
                    ]),
                    _: 1
                  }),
                  vue.createVNode(_component_Tooltip, { title: "隐藏第一个@用户，双击内容可显示原文" }, {
                    default: vue.withCtx(() => [
                      vue.createElementVNode("div", {
                        ...
                        onClick: _cache[5] || (_cache[5] = ($event) => $options.changeOption($options.CommentDisplayType.FloorInFloorNoCallUser))
                      }, "楼中楼 ", 2)
                    ]),
                    _: 1
                  }),
                  vue.createVNode(_component_Tooltip, { title: "重复显示楼中楼的回复" }, {
                    default: vue.withCtx(() => [
                      vue.createElementVNode("div", {
                        ...
                        onClick: _cache[6] || (_cache[6] = ($event) => $options.changeOption($options.CommentDisplayType.FloorInFloorNested))
                      }, "冗余楼中楼 ", 2)
                    ]),
                    _: 1
                  }),
                  vue.createElementVNode("div", {
                    ...
                    onClick: _cache[7] || (_cache[7] = ($event) => $options.changeOption($options.CommentDisplayType.Like))
                  }, "感谢 ", 2),
                  vue.createElementVNode("div", {
                    class: vue.normalizeClass(["radio", $props.displayType === $options.CommentDisplayType.OnlyOp ? "active" : ""]),
                    onClick: _cache[8] || (_cache[8] = ($event) => $options.changeOption($options.CommentDisplayType.OnlyOp))
                  }, "只看楼主 ", 2),
                  vue.createElementVNode("div", {
                    class: vue.normalizeClass(["radio", $props.displayType === $options.CommentDisplayType.V2exOrigin ? "active" : ""]),
                    onClick: _cache[9] || (_cache[9] = ($event) => $options.changeOption($options.CommentDisplayType.V2exOrigin))
                  }, "V2原版 ", 2)
                ], 2),
  ...
  const PostDetail = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$2], ["__scopeId", "data-v-5fecd755"]]);
  const _withScopeId$2 = (n2) => (vue.pushScopeId("data-v-b42546ed"), n2 = n2(), vue.popScopeId(), n2);
  const _hoisted_1$4 = /* @__PURE__ */ _withScopeId$2(() => /* @__PURE__ */ vue.createElementVNode("svg", {
    width: "24",
    height: "24",
    viewBox: "0 0 48 48",
    fill: "none",
  ...
  const Base64Tooltip = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-b42546ed"]]);
  const _sfc_main$3 = {
    name: "Msg",
    props: {
      type: "",
  ...
  const _withScopeId$1 = (n2) => (vue.pushScopeId("data-v-6683a3c1"), n2 = n2(), vue.popScopeId(), n2);
  const _hoisted_1$2 = { class: "wrapper" };
  const _hoisted_2$1 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "title" }, " 添加标签 ", -1));
  const _hoisted_3$1 = { class: "option" };
  const _hoisted_4$1 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ vue.createElementVNode("span", null, "用户：", -1));
  ...
  const TagModal = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-6683a3c1"]]);
  ...
  const MsgModal = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-868aa501"]]);
  ...
  const _sfc_main = {
    ...
    created() {
      ...
      $(document).on("click", "a", (e2) => {
        ...
        if (id) {
          this.clickPost(e2, id, href, title);
        }
      });
        ...
        if (id) {
          if (this.config.clickPostItemOpenDetail) {
            ...
            if (postItem.replies) {
              ...
              let r2 = await window.parse.checkPostReplies(id, true);
              if (r2)
                return true;
            }
            postItem.id = id;
  ...
  const _withScopeId = (n2) => (vue.pushScopeId("data-v-c60de789"), n2 = n2(), vue.popScopeId(), n2);
  const _hoisted_1 = {
    key: 0,
    class: "nav flex flex-end list-switch"
  };
  const _hoisted_2 = {
    key: 1,
    class: "target-user-tags"
  };
  const _hoisted_3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ vue.createElementVNode("span", null, "标签：", -1));
  const _hoisted_4 = { class: "my-tag" };
  const _hoisted_5 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ vue.createElementVNode("i", { class: "fa fa-tag" }, null, -1));
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
      ...
      !$data.stopMe && $data.config.showToolbar ? (vue.openBlock(), vue.createElementBlock("div", {
        ...
        $options.isMember && $data.isLogin && $data.config.openTag ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2, [
          _hoisted_3,
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.targetUserTags, (i) => {
            return vue.openBlock(), vue.createElementBlock("span", _hoisted_4, [
              _hoisted_5,
              vue.createElementVNode("span", null, vue.toDisplayString(i), 1),
              vue.createElementVNode("i", {
                class: "fa fa-trash-o remove",
        ...
        $options.isPost && !$data.show ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_7, [
          vue.createElementVNode("div", _hoisted_8, [
            vue.createTextVNode(" 默认显示楼中楼 ： "),
            vue.createElementVNode("div", {
              class: vue.normalizeClass(["switch light", { active: $data.config.autoOpenDetail }]),
              onClick: _cache[8] || (_cache[8] = ($event) => $data.config.autoOpenDetail = !$data.config.autoOpenDetail)
            }, null, 2)
          ]),
          vue.createElementVNode("div", {
            class: vue.normalizeClass(["button light", { loading: $data.loading, isNight: $data.isNight }]),
            onClick: _cache[9] || (_cache[9] = (...args) => $options.showPost && $options.showPost(...args))
          }, " 点击显示楼中楼 ", 2)
        ])) : vue.createCommentVNode("", true)
      ], 2)) : vue.createCommentVNode("", true)
    ], 64);
  }
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-c60de789"]]);
  ...
  function run() {
          ...
          imgWebs.map((v, i) => {
            ...
            res2.map((r2) => {
              ...
              if (p) {
                ...
                str = str.replace(r2[0], `<img src="${src}" data-originUrl="${p}" data-notice="这个img标签由v2ex-超级增强脚本解析" style="max-width: 100%">`);
              }
            });
          });
        } catch (e2) {
      ...
      async checkPostReplies(id, needOpen = true) {
        return new Promise(async (resolve) => {
          ...
          if (r2) {
            ...
            if (res) {
              if (((_a = res[0]) == null ? void 0 : _a.replies) > 300) {
                if (needOpen) {
    ...
    function feedback() {
      _GM_openInTab("https://github.com/zyronon/v2ex-script/issues", {
        active: true,
        insert: true,
        setParent: true
      });
    ...
    function checkPageType() {
      ...
      if (location2.pathname === "/") {
        ...
        let r2 = location2.href.match(/.com\/t\/([\d]+)/);
        if (r2) {
    ...
    function initSoV2ex() {
      ...
      $search.on("input", function(e2) {
        oInputEvent(e2);
        $(".search-item:last").attr("href", "https://www.sov2ex.com/?q=" + $search.val()).text("sov2ex " + $search.val());
      });
      $search.keydown(function(e2) {
        if (e2.code == "Enter" || e2.code == "NumpadEnter" || e2.keyCode === 13) {
    ...
    async function init() {
      ...
      switch (window.pageType) {
        ...
        case PageType.Post:
          box = document.querySelector("#Wrapper #Main .box");
          box.after($section);
          let r2 = await window.parse.checkPostReplies(window.pageData.id, false);
          if (r2) {
            window.stopMe = true;
